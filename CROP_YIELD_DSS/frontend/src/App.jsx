...
function App() {
  ...
  // SHARED STATE: Links Map Clicks to Prediction inputs
  const [selectedPoint, setSelectedPoint] = useState({ lat: 1.0435, lon: 34.9589 });
  ...
  const showNotification = (message, type = 'info') => {
    ...
    if (message.includes('Viewing asset')) setActiveTab('map');
    ...
    <>
      ...
      <div className="container">
        ...
        <main>
          ...
          {activeTab === 'map' && <FieldMap onPointSelect={setSelectedPoint} />}
          {activeTab === 'prediction' && <PredictionPanel selectedPoint={selectedPoint} showNotification={showNotification} />}
