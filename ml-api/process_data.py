...
def parse_args():
    ...
    parser.add_argument('--input', type=str, default=r'D:\WORK\CROP_DSS\CROP_YIELD_DSS\ml-api\Data\ee-chart.csv', 
                        help="Path to input NDVI CSV (relative or absolute).")
    parser.add_argument('--output', type=str, default=r'D:\WORK\CROP_DSS\CROP_YIELD_DSS\ml-api\Data\training_data_real.csv', 
